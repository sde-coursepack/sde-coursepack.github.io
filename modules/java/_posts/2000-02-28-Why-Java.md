...
The above is not to say Java is perfect; it has flaws like every
...
which we will reference later this term, wrote nearly all of the code in the book in Java. Yet, with regards to Checked Exceptions, he said the following:
