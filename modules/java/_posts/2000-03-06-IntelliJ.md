...
<img alt="alt" src="{{site.baseurl}}/modules/java/images/7/new_project.png"/>
...
to access that location with another program, like terminal.

From there, under language, select **Java**

Under Build System, select **Gradle** - **THIS IS NOT THE DEFAULT OPTION** - we will talk
more about Gradle in future modules, but we want to start by making sure everyone knows
where IntelliJ expects Java files to be in a Gradle Project.

Under **JDK**, select the most recent version of Java that you have. You can also
download the most recent Java JDK by going to "Download JDK" in the JDK DropDown.

At minimum, you should be using Java 8 or later. I recommend using Java 17 or 18.

Finally, under **Gradle DSL**, leave "Groovy" selected.
...
<img alt="alt" src="{{site.baseurl}}/modules/java/images/7/starting_point.png"/>
...
<img alt="alt" src="{{site.baseurl}}/modules/java/images/7/hello_world.png"/>

---

## Running a Java file

Now that we have our file ready to run, you can run the file by either
clicking either "green arrow" sign on HelloWorld or right clicking in empty space
and selecting "Run". If you don't see the option to run, make absolute certain
...
<img alt="alt" src="{{site.baseurl}}/modules/java/images/7/post_run.png"/>
...
time being you can ignore them. We will talk about deprication a little
bit later on in the class.

---

## Using Packages

As we have discussed before, we want all of our code in packages, as we want
to avoid using the default package.

So, right-click on the "src/main/java" folder and go to "New"->"Package"

Then add the package "edu.virginia.cs.hello".

Finally, click and drag your HelloWorld.java file into the package we have
...
You should now see HelloWorld.java inside of the correct package:

<img alt="alt" src="{{site.baseurl}}/modules/java/images/7/new_package_refactor.png"/>
...
<img alt="alt" src="{{site.baseurl}}/modules/java/images/7/modify_run_configurations.png"/>

From here, we need to add a command line argument. So in the window that pops up,
add the number 10 to "Program Arguments":

<img alt="alt" src="{{site.baseurl}}/modules/java/images/7/new_run_configuration.png"/>

Now hit "Apply" and "Run"

And you should see your program successfully run:

<img alt="alt" src="{{site.baseurl}}/modules/java/images/7/run_ntimes.png"/>
...
<img alt="alt" src="{{site.baseurl}}/modules/java/images/7/project_structure.png"/>

When you click on it, you should see:

<img alt="alt" src="{{site.baseurl}}/modules/java/images/7/project_structure_window.png"/>
