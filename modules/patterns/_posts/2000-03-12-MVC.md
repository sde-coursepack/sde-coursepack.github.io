...
*Note: we won't actually be using this templating language in the course. It was made up for this example. If you want to look at an actual language for views, check out our article on [FXML](/modules/gui/FXML/).*
