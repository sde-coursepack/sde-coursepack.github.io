...
of *complexity* is going to get in our way.
...
point of this function is to find the largest number of our 3 inputs, we can 
...
So this means any test that executes the static fault, right?
...
**How could we have found this bug without thorough testing?**
