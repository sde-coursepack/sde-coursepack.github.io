...
Of course, we can't always have **every** class have exactly one purely functional method. For example, data structure classes will typically have a constructor and getters and setters.
